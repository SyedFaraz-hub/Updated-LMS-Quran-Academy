...
<body>
  ...
  <?php include '../Components/Navbar.php'; ?>
    ...
    <div class="containerforGenericCourseContent">
        <div class="row">
            <div class="col-3">
      ...
      <?php include '../Components/SideBar.php'; ?>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="jquery-remove">
                    <section class="main-article-CourseContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-m-6 col-sm-12">
                                <div class="form-article-CourseContent">
                                    <form class="d-flex">
