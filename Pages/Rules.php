...
<body>
  ...
  <!-- rule main heading start  -->
  <div class="container">
    <div class="ruleheading-rules">
      <h1>Rules</h1>
    </div>
  </div>
  <!-- rule main heading end -->



  <!-- section paragraph start -->
  <div class="container mb-20px">
    <div class="rulesection-rules">
      <h1 class="paraheading-rules">Lorem ipsum dolor sit</h1>
      <p class="paratext-rules">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum
        laoreet. Proin
        ...
        eget odio. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet.
