        ...
        <div class="container-form2">
          <form class="row g-3 ml-0px">
            ...
            <div class="center col-15">
              <br><button type="submit" class="btn btn-outline-primary mb-15px" data-bs-toggle="modal"
                data-bs-target="#exampleModal2"> <a class="underlineremove-and-colorwhite">Submit </a></button>
            </div>
          </form>
        </div>
      </div>
